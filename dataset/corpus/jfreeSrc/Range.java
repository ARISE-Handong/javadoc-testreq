...
public strictfp class Range implements Serializable {
     ...
     * <P>
     * Note that: <li>either range can be <code>null</code>, in which case the other range is returned;</li>
     * Note that: <li>if both ranges are <code>null</code> the return value is <code>null</code>.</li>
     *
    ...
    /**
     * Returns a new range that spans both <code>range1</code> and  <code>range2</code>.  
	 ...
	 *  If either value is NaN, the other value is  returned.
     ...
     * @param base  the base range (<code>null</code> not permitted).
     * @param delta  the shift amount.
     * @param allowZeroCrossing  a flag that determines whether or not the bounds of the range are allowed to cross zero after adjustment.
     *
     * @return A new range.
     */
    public static Range shift(Range base, double delta,
    ...
    /**
     * Returns <code>true</code> if both the lower and upper bounds are  <code>Double.NaN</code>, and <code>false</code> otherwise.
     * 
     * @return A boolean.
     * 
     * @since 1.0.18
