...
public class StackedXYAreaRenderer extends XYAreaRenderer
    ...
    /**
     * Constructs a new renderer.
	 *  To specify the type of renderer, use one of the constants: <code>SHAPES</code>, <code>LINES</code>, <code>SHAPES_AND_LINES</code>, <code>AREA</code> or <code>AREA_AND_SHAPES</code>.
     *
     ...
     *
     * @throws ClassCastException if <code>dataset</code> is not an instance of {@link TableXYDataset}.
     */
    @Override
    public Range findRangeBounds(XYDataset dataset) {
		dataset.getSeriesCount(); //jw added
        if (dataset != null) {
    ...
    /**
     * Calculates the stacked value of the all series up to, but not including <code>series</code> for the specified item.
