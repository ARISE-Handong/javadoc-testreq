...
public class HistogramDataset extends AbstractIntervalXYDataset
	 ...
	 * Any data value less than minimum will be assigned to the first bin, and any data value greater than maximum will be assigned to the last bin.
	 ...
	 * But other renderers can use it (for example, you could use the dataset to create a line chart).
     *
     * @param series  the series index (in the range <code>0</code> to <code>getSeriesCount() - 1</code>).
