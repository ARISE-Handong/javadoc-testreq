...
public abstract class Marker implements Cloneable, Serializable {
     ...
     *
     * @throws IllegalArgumentException if {@code paint} or {@code stroke} is {@code null}, or {@code alpha} is not in the specified range.
     */
    ...
    /**
     * Sets the paint and sends a {@link MarkerChangeEvent} to all registered listeners.
     *
     * @param paint  the paint ({@code null} not permitted).
     *
     * @see #getPaint()
    ...
    /**
     * Sets the stroke and sends a {@link MarkerChangeEvent} to all registered listeners.
     *
     * @param stroke  the stroke ({@code null}not permitted).
     *
     * @see #getStroke()
    ...
    /**
     * Sets the alpha transparency that should be used when drawing the marker, and sends a {@link MarkerChangeEvent} to all registered listeners.
	 * The alpha transparency is a value in the range 0.0f (completely transparent) to 1.0f (completely opaque).
     *
     * @param alpha  the alpha transparency (must be in the range 0.0f to 1.0f).
     *
     * @throws IllegalArgumentException if {@code alpha} is not in the specified range.
     *
     * @see #getAlpha()
     */
    ...
    /**
     * Sets the label (if {@code null} no label is displayed) and sends a {@link MarkerChangeEvent} to all registered listeners.
     *
    ...
    /**
     * Sets the label paint and sends a {@link MarkerChangeEvent} to all registered listeners.
     *
     * @param paint  the paint ({@code null} not permitted).
     *
     * @see #getLabelPaint()
	 ...
	 * The default value is  {@code Color(100, 100, 100, 100)}..
     * 
	 ...
	 *  This defines the position of the label anchor, relative to the bounds of the marker.
     *
    ...
    /**
     * Sets the label anchor and sends a {@link MarkerChangeEvent} to all registered listeners. 
	 * The anchor defines the position of the label anchor, relative to the bounds of the marker.
     *
    ...
    /**
     * Sets the label offset and sends a {@link MarkerChangeEvent} to all registered listeners.
     *
    ...
    /**
     * Sets the label offset type and sends a {@link MarkerChangeEvent} to all registered listeners.
     *
