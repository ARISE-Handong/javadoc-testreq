...
public class TimeSeries extends Series implements Cloneable, Serializable {
	 ...
	 *  By default, a daily time series is created.	
	 ...
	 * One situation where this is helpful is when generating a chart for the time series axis labels can be taken from the domain and range description.
     *
	 ...
	 *  Then, when you add a new data item, all data items more than 30 days older than the latest value are automatically dropped from the series.
     *
	 ...
	 * Any <code>null</code> data values in the series will be ignored (except for the special case where all data values are <code>null</code>, in which case the return value is <code>Range(Double.NaN, Double.NaN)</code>).  
	 * If the time series contains no items, this method will return <code>null</code>.
     * 
     * @return The range of y-values in the time series (possibly  <code>null</code>).
     * 
     * @since 1.0.18
     */
	 ...
	 *  This is equivalent to <code>findValueRange(xRange, TimePeriodAnchor.MIDDLE, timeZone)</code>.
     * 
     * @param xRange  the subrange of x-values (<code>null</code> not permitted).
     * @param timeZone  the time zone used to convert x-values to time periods (<code>null</code> not permitted).
     * 
     * @return The range. 
     * 
     * @since 1.0.18
     ...
     * 
     * @param xRange  the subset of x-values to use (<code>null</code> not permitted).
     * @param xAnchor  the anchor point for the x-values (<code>null</code> not permitted).
    ...
    /**
     * Returns the smallest y-value in the series, ignoring any <code>null</code> and <code>Double.NaN</code> values. 
	 * This method returns <code>Double.NaN</code> if there is no smallest y-value (for example, when the series is empty).
     *
    ...
    /**
     * Returns the largest y-value in the series, ignoring any  <code>null</code> and <code>Double.NaN</code> values. 
	 * This method returns <code>Double.NaN</code> if there is no largest y-value (for example, when the series is empty).
     *
     ...
     * If you add a data item with a {@link Year} for the time period, then all subsequent data items must also have a {@link Year} for the time period.
     *
     * @return The time period class (may be <code>null</code> but only for an empty series).
     */
	 ...
	 * Note that the returned object is a clone of the item in the series, so modifying it will have no effect on the data series.
     * 
	 ...
	 * This method returns the object that is used for the underlying storage - you should not modify the contents of the returned value unless you know what you are doing.
     *
	 ...
	 * If there is no data item with the specified period, this method will return <code>null</code>.
     *
    ...
    /**
     * Adds a new data item to the series and sends a {@link org.jfree.data.general.SeriesChangeEvent} to all registered listeners.
     *
     * @param period  the time period (<code>null</code> not permitted).
	 ...
	 *  Throws a {@link SeriesException} if the period does not exist.
     *
	 ...
	 *  Returns another series containing the values that were overwritten.
     *
	 ...
	 * Ensure that the timespan from the youngest to the oldest record in the series does not exceed maximumItemAge time periods.
	 *  Oldest items will be removed if required.
     *
     * @param notify  controls whether or not a {@link SeriesChangeEvent} is sent to registered listeners IF any items are removed.
     */
    ...
    /**
     * Age items in the series.
	 * Ensure that the timespan from the supplied time to the oldest record in the series does not exceed history count.
     * oldest items will be removed if required.
     *
    ...
    /**
     * Deletes the data item for the given time period and sends a {@link SeriesChangeEvent} to all registered listeners. 
    ...
    /**
     * Creates a new (empty) time series with the specified name and class of {@link RegularTimePeriod}.
     *
     * @param name  the series name (<code>null</code> not permitted).
     * @param timePeriodClass  the type of time period (<code>null</code> not permitted).
     *
     * @deprecated As of 1.0.13, it is not necessary to specify the <code>timePeriodClass</code> as this will be inferred when the first data item is added to the dataset.
     */
