...
public class MapUtilsTest extends AbstractAvailableLocalesTest {
    ...
    public void testLazyMapFactory() {
        ...
        try {
            Map<Object, Object> map = MapUtils.lazyMap(new HashMap<>(), (Factory<Object>) null);
        ...
        try {
        	final Factory<Integer> factory = FactoryUtils.constantFactory(Integer.valueOf(5));
            Map<Object, Object> map = MapUtils.lazyMap((Map<Object, Object>) null, factory);
            fail("Expecting NullPointerException for null map");
        } catch (final NullPointerException e) {
            // expected
        }
        ...
        Map<Object, Object> map = MapUtils.lazyMap(new HashMap<>(), transformer);
        assertTrue(map instanceof LazyMap);

        try {
            Map<Object, Object> map = MapUtils.lazyMap(new HashMap<>(), (Transformer<Object, Object>) null);
        ...
        final Transformer<Object, Integer> transformer = TransformerUtils.asTransformer(factory);
        try {
            Map<Object, Object> map = MapUtils.lazyMap((Map<Object, Object>) null, transformer);
            fail("Expecting NullPointerException for null map");
        } catch (final NullPointerException e) {
            // expected
        }
    ...
    public void testPutAll_Map_array() {
        ...
        // sub array
        Map<String, String> test = MapUtils.putAll(new HashMap<String, String>(), new String[][] {
            {"RED", "#FF0000"},
            {"GREEN", "#00FF00"},
            {"BLUE", "#0000FF"}
        });
        ...
        Map<String, String> test = MapUtils.putAll(new HashMap<String, String>(), null);
        assertEquals(0, test.size());

        // map entry
        Map<String, String> test = MapUtils.putAll(new HashMap<String, String>(), new Object[] {
