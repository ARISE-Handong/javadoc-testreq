...
public final class BitUtil {
  ...
  public static final long flipFlop(final long b) {
	...
	* Assuming the input is a signed long whose absolute value can be stored on <tt>n</tt> bits, the returned value will be an unsigned long that can be stored on <tt>n+1</tt> bits.
    */
   ...
   * @param bitIndex The bit zero-based index.
   *		It must be greater than or equal to 0, and strictly less than {@code numLongs * Long.SIZE}.
   */
   ...
   * @param bits     The bits stored in an array of long for efficiency.
   * @param numLongs The number of longs in {@code bits} to consider.
   * @param bitIndex The bit zero-based index, exclusive.
   *			It must be greater than or equal to 0, and less than or equal to {@code numLongs * Long.SIZE}.
   */
   ...
   * @param numLongs The number of longs in {@code bits} to consider.
   * @param bitIndex The bit zero-based index. 
   *				It must be greater than or equal to -1, and strictly less than {@code numLongs * Long.SIZE}.
