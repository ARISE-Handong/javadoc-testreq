...
public final class LambdaUtil {
     ...
     * @return an array containing the results of evaluating the lambda expressions (or {@code null} if the suppliers array was {@code null}
     */
	 ...
	 * If the supplied value is of type Message, this method returns the result of calling {@code #getFormattedMessage} on that Message.
     * @param supplier a lambda expression or {@code null}
     * @return the results of evaluating the lambda expression (or {@code null} if the supplier was {@code null}
     */
     ...
     * @param supplier a lambda expression or {@code null}
     * @return the Message resulting from evaluating the lambda expression (or {@code null} if the supplier was {@code null}
     */
     ...
     * @param supplier a lambda expression or {@code null}
     * @return the Message resulting from evaluating the lambda expression or the Message created by the factory for supplied values that are not of type Message
     */
