...
public class IteratorUtils {
    ...
    /**
     * Decorates the specified iterator to return at most the given number of elements, skipping all elements until the iterator reaches the position at {@code offset}.
     * <p>
    ...
    //-----------------------------------------------------------------------
    /**
     * Gets an immutable version of an {@link Iterator}. 
	 * The returned object will always throw an {@link UnsupportedOperationException} for the {@link Iterator#remove} method.
     *
     * @param <E> the element type
    ...
    /**
     * Gets an immutable version of a {@link ListIterator}.
	 * The returned object will always throw an {@link UnsupportedOperationException} for the {@link Iterator#remove}, {@link ListIterator#add} and {@link ListIterator#set} methods.
     *
     * @param <E> the element type
    ...
    /**
     * Gets an immutable version of a {@link MapIterator}.
	 * The returned object will always throw an {@link UnsupportedOperationException} for the {@link Iterator#remove}, {@link MapIterator#setValue(Object)} methods.
     *
     * @param <K> the key type
     * @param <V> the value type
     ...
     * <p>
     * Given two ordered {@link Iterator}s <code>A</code> and <code>B</code>, the {@link Iterator#next()} method will return the lesser of <code>A.next()</code> and <code>B.next()</code>.
     * <p>
     ...
     * <p>
     * Given two ordered {@link Iterator}s <code>A</code> and <code>B</code>, the {@link Iterator#next()} method will return the lesser of <code>A.next()</code> and <code>B.next()</code> and so on.
     * <p>
     * The comparator is optional. 
	 * If null is specified then natural order is used.
     *
     ...
     *                 |- Branch -- Leaf
     *                 |- Branch -- Leaf</pre>
     * The following <code>Transformer</code>, used in this class, will extract all the Leaf objects without creating a combined intermediate list:
     * <pre>
	 ...
	 * When next is called, the transformer is called to examine the object.
	 * The transformer will return either an iterator or an object.
	 * If the object is an Iterator, the next element from that iterator is obtained and the process repeats. 
	 ...
	 * The returned {@link Iterable} can be used for a single iteration.
     *
     * @param <E> the element type
     * @param iterator  the iterator to use, may not be null
	 ...
	 * The returned iterable can be used for multiple iterations.
     *
     * @param <E> the element type
     * @param iterator  the iterator to use, may not be null
    ...
    /**
     * Returns the <code>index</code>-th value in {@link Iterator}, throwing <code>IndexOutOfBoundsException</code> if there is no such element.
     * <p>
     * The Iterator is advanced to <code>index</code> (or to the end, if <code>index</code> exceeds the number of entries) as a side effect of this method.
     *
     ...
     * <p>
     * Returns the <code>first</code> value in {@link Iterator}, throwing <code>IndexOutOfBoundsException</code> if there is no such element.
     * </p>
     * <p>
     * The Iterator is advanced to <code>0</code> (or to the end, if <code>0</code> exceeds the number of entries) as a side effect of this method.
     * </p>
     * @param <E> the type of object in the {@link Iterator}
     * @param iterator the iterator to get a value from
     ...
     * <p>
     * The string representation consists of a list of the iterator's elements, enclosed in square brackets ({@code "[]"}).
	 * Adjacent elements are separated by the characters {@code ", "} (a comma followed by a space).
     ...
     * Returns a string representation of the elements of the specified iterator.
     * <p>
     * The string representation consists of a list of the iterable's elements, enclosed in square brackets ({@code "[]"}).
	 * Adjacent elements are separated by the characters {@code ", "} (a comma followed by a space).
	 * Elements are converted to strings as by using the provided {@code transformer}.
     *
     * @param <E> the element type
     * @param iterator  the iterator to convert to a string, may be null
     ...
     * Returns a string representation of the elements of the specified iterator.
     * <p>
     * The string representation consists of a list of the iterator's elements, enclosed by the provided {@code prefix} and {@code suffix}.
	 * Adjacent elements are separated by the provided {@code delimiter}.
	 * Elements are converted to strings as by using the provided {@code transformer}.
     *
     * @param <E> the element type
     * @param iterator  the iterator to convert to a string, may be null
