...
public class ClosureUtils {
     ...
     * The closure at array location 0 is called if the predicate at array location 0 returned true.
	 * Each predicate is evaluated until one returns true. 
	 * If no predicates evaluate to true, the default closure is called.
     *
     * @see org.apache.commons.collections4.functors.SwitchClosure
     *
     * @param <E>  the type that the closure acts on
     ...
     * Create a new Closure that calls one of the closures depending on the predicates.
     * <p>
     * The Map consists of Predicate keys and Closure values.
	 * A closure is called if its matching predicate returns true.
	 * Each predicate is evaluated until one returns true. 
	 * If no predicates evaluate to true, the default closure is called.
	 * The default closure is set in the map with a null key.
     ...
     * <p>
     * The Map consists of object keys and Closure values.
	 * A closure is called if the input object equals the key.
	 * If there is no match, the default closure is called. 
