...
public class MultiSetUtils {
	 ...
	 * Any modification attempts to the returned multiset will raise an {@link UnsupportedOperationException}.
     *
     * @param <E> the element type
     ...
     * <p>
     * Only objects that pass the test in the given predicate can be added to the multiset. 
	 * Trying to add an invalid object results in an IllegalArgumentException.
	 * It is important not to use the original multiset after invoking this method, as it is a backdoor for adding invalid objects.
     *
     * @param <E> the element type
