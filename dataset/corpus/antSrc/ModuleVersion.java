...
public class ModuleVersion {
	 ...
	 * This cannot contain an ASCII hyphen ({@code -}) or plus ({@code +}), as those characters are used as delimiters in a complete module version string.
     *
     * @param number version number
     * @throws NullPointerException if argument is {@code null}
     * @throws IllegalArgumentException if argument contains {@code '-'} or {@code '+'}
     */
	 ...
	 * This can be any value which doesn't contain an ASCII plus ({@code +}).
     *
	 ...
	 * This can be any value, including {@code null}.
     *
    ...
    /**
     * Snapshots this element's state and converts it to a string compliant with {@code ModuleDescriptor.Version}.
     *
     * @return Java module version string built from this object's properties
     *
     * @throws IllegalStateException if {@linkplain #getNumber() number} is {@code null}
     */
