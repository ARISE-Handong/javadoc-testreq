...
public class PresentSelector extends BaseSelector {
     ...
     * It could be a <code>negate</code> boolean, but by doing things this way, we get some documentation on how the system works.
     * A user looking at the documentation should clearly understand that the ONLY files whose presence is being tested are those that already exist in the source directory, hence the lack of a <code>destonly</code> option.
     *
     * @param fp An attribute set to either <code>srconly</code> or <code>both</code>.
     */
	 ...
	 * In this case, it means that the targetdir attribute has been set and we have a mapper.
     */
    @Override
